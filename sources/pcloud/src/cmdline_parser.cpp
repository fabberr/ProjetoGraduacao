...
void ctrl::help(std::ostream& os) {
	os << 
		...
		"\n" 
		"<input_path>:\n" 
		"    Caminho até o diretório contendo as imagens do dataset.\n" 
		"    Note que as images passadas devem ter sido capturadas em sequência, em torno\n" 
		"    do objeto a ser recriado. Este algoritmo não funciona com sequências de\n" 
